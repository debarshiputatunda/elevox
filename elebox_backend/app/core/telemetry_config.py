...
TELEMETRY_POLL_INTERVAL_S = _float_env("TELEMETRY_POLL_INTERVAL_S", 0.1)
TELEMETRY_POLL_INTERVAL_HIGH_S = _float_env("TELEMETRY_POLL_INTERVAL_HIGH_S", 0.1)
TELEMETRY_POLL_INTERVAL_ACTIVE_S = _float_env("TELEMETRY_POLL_INTERVAL_ACTIVE_S", 0.1)
