...
def build_ws_payload(
    ...
    *,
    ...
    return {
        ...
        "hook_alarm_ranges": reading.hook_alarm_ranges,
        "hook_ranges_revision": reading.hook_ranges_revision,
        "hook_raw_a": reading.hook_raw_a,
        "hook_raw_b": reading.hook_raw_b,
        "guard": reading.guard,
        "sensing_mode": reading.sensing_mode,
        "sensing_name": reading.sensing_name,
        "link": reading.link,
        "mutual": reading.mutual,
        "mutual_valid": reading.mutual_valid,
        "mutual_status": reading.mutual_status,
        "hook_observed_a": reading.hook_observed_a,
        "hook_observed_b": reading.hook_observed_b,
        "a_timeouts": reading.a_timeouts,
        "b_timeouts": reading.b_timeouts,
        "hook_sample_count": reading.hook_sample_count,
        "hook_timeout_cycles": reading.hook_timeout_cycles,
